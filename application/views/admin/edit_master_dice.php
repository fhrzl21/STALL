<div class="container-fluid">
    ...
    <form action="<?php echo base_url('Admin/dice_update_proses') ?>" method="post">
        ...
        <div class="form-group row" id="row_identitas_master_dies">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="identitas_master_dies" value="<?php echo $master_dies->identitas_master_dies ?>" readonly>
            </div>
        </div>
        ...
        <div class="form-group row" id="row_tanggal_pembuatan">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="tanggal_pembuatan" value="<?php echo date('d/m/Y', strtotime($master_dies->tanggal_pembuatan)) ?>" readonly>
            </div>
        </div>
