<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <h2 class="m-0 font-weight-bold text-primary">Validasi QC PM10</h2>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php if ($logP->tanggal_validasi_pm10 == '0000-00-00 00:00:00') {
                                        echo " ";
                                    } else {
                                        echo date('d/m/Y', strtotime($logP->tanggal_validasi_pm10));
                                    } ?></td>
                                <td><?php echo $logP->status_validasi_pm10 ?></td>
                                <td nowrap>
                                    <!-- <div class="btn-group">
                                    ...
                                    <?php if (empty($logP->status_validasi_pm10)) { ?>
                                        <div class="btn-group">
                                            <a href="<?php echo base_url('Admin/validasi_qc_pm10/' . $logP->log_id); ?>" class="btn btn-success btn-sm"><i class="fas fa-check"></i> Validasi</a>
                                        </div>

                                        <div class="btn-group">
                                            <a href="<?php echo base_url('Admin/tolak_validasi_qc_pm10/' . $logP->log_id); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Untuk Tidak Validasi Cylinder?')"><i class="fas fa-times"></i> Tolak</a>
                                        </div>
                                    <?php } else { ?>
