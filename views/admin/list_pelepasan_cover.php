                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if (empty($logP->tanggal_lepas_cover) || $logP->tanggal_lepas_cover == "0000-00-00") { ?>
                                        <div class="btn-group">
                                            <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-eject"></i> Lepas</a>
                                        </div>
                                    <?php } ?>
                                    <!-- <div class="btn-group">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <b>Apakah Anda Yakin Melepas Cover Cylinder?</b>
                            </div>
                            <div class="modal-footer">
                                <a href="<?php echo base_url('Admin/lepas_cover_proses/' . $logP->log_id . '/' . $logP->cover_id . '/' . $logP->cylinder_id); ?>"><button type="button" class="btn btn-warning">Ya</button></a>
